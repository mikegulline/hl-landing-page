        ...
        <div className='container mx-auto'>
          <div className='p-5'>
            <ul className='flex flex-wrap-reverse md:flex-nowrap justify-between items-center gap-5'>
              <li className='w-full border-t-4 border-gray-300 border-solid pt-5 md:border-t-0 md:pt-0'>
              ...
              <li>
                <Link
                  href='/contact'
                  className=' text-white font-light block underline hover:text-gray-400'
                >
                  Contact
                </Link>
              </li>
