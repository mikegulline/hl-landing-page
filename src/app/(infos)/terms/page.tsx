    ...
    <div className='background  text-white/80 overflow-hidden relative bg-fuchsia-950'>
      <div className='container max-w-screen-md mx-auto py-10 lg:py-20'>
        <div className='px-5'>
          ...
          <div className='pb-14 text-white font-medium text-lg  mb-5 border-b border-dashed border-fuchsia-400/50'>
            ...
            <p>
              ...
              please do not use this site.Privacy Policy
            </p>
          </div>
          <div className='pb-14 mb-5 border-b border-dashed border-fuchsia-400/50'>
            ...
            <p>
              ...
              property of www.hemplandusa.com. The collective work includes
              works that are licensed to www.hemplandusa.com. Copyright 2014,
              www.hemplandusa.com ALL RIGHTS RESERVED. Permission is granted to
              electronically copy and print hard copy portions of this site for
              the sole purpose of placing an order with www.hemplandusa.com or
              purchasing www.hemplandusa.com products. You may display and,
              subject to any expressly stated restrictions or limitations
              ...
              non-commercial use, or to place an order with www.hemplandusa.com
              or to purchase www.hemplandusa.com products. Any other use,
              ...
              prohibited, unless authorized by www.hemplandusa.com. You further
          ...
          <div className='pb-14 mb-5 border-b border-dashed border-fuchsia-400/50'>
            ...
            <p>
              ...
              www.hemplandusa.com used in the site are trademarks or registered
              trademarks of www.hemplandusa.com
            </p>
          </div>
          <div className='pb-14 mb-5 border-b border-dashed border-fuchsia-400/50'>
            <h3 className='font-medium text-fuchsia-300 text-2xl mb-4'>
            ...
            <p>
              ...
              free of viruses or other harmful components. www.hemplandusa.com
              does not make any warrantees or representations regarding the use
              of the materials in this site in terms of their correctness,
          ...
          <div className='pb-14 mb-5 border-b border-dashed border-fuchsia-400/50'>
            ...
            <p>
              www.hemplandusa.com shall not be liable for any special or
              consequential damages that result from the use of, or the
              inability to use, the materials on this site or the performance of
              the products, even if www.hemplandusa.com has been advised of the
              possibility of such damages. Applicable law may not allow the
              limitation of exclusion of liability or incidental or
          ...
          <div className='pb-14 mb-5 border-b border-dashed border-fuchsia-400/50'>
            ...
            <p>
              In the event that a www.hemplandusa.com product is mistakenly
              listed at an incorrect price, www.hemplandusa.com reserves the
              right to refuse or cancel any orders placed for product listed at
              the incorrect price. www.hemplandusa.com reserves the right to
              ...
              already been charged for the purchase and your order is cancelled,
              www.hemplandusa.com shall issue a credit to your credit card
          ...
          <div className='pb-14 mb-5 border-b border-dashed border-fuchsia-400/50'>
            ...
            <p>
              ...
              terminated by www.hemplandusa.com without notice at any time, for
              any reason. The provisions relating to Copyrights, Trademark,
          ...
          <div className='pb-14 mb-5 border-b border-dashed border-fuchsia-400/50'>
            ...
            <p>
              www.hemplandusa.com may deliver notice to you by means of e-mail,
              a general notice on the site, or by other reliable method to the
              address you have provided to www.hemplandusa.com.
            </p>
          </div>
          <div className='pb-14 mb-5 border-b border-dashed border-fuchsia-400/50'>
            <h3 className='font-medium text-fuchsia-300 text-2xl mb-4'>
            ...
            <p>
              ...
              laws of the state of California, U.S.A., without regard to choice
              of law provisions, and not by the 1980 U.N. Convention on
              contracts for the international sale of goods. You agree that
              jurisdiction over and venue in any legal proceeding directly or
              indirectly arising out of or relating to this site (including but
              not limited to the purchase of www.hemplandusa.com products) shall
              be in the state or federal courts located in Los Angeles County,
              California. Any cause of action or claim you may have with respect
          ...
          <div className='pb-14 mb-5 border-b border-dashed border-fuchsia-400/50'>
            ...
            <p>
              arassment in any manner or form on the site, including via e-mail,
              chat, or by use of obscene or abusive language, is strictly
              forbidden. Impersonation of others, including a
              www.hemplandusa.com or other licensed employee, host, or
              representative, as well as other members or visitors on the site
              is prohibited. You may not upload to, distribute, or otherwise
              publish through the site any content which is libelous,
              ...
              any party or which may otherwise give rise to liability or violate
              any law. You may not upload commercial content on the site or use
              the site to solicit others to join or become members of any other
          ...
          <div className='pb-14 mb-5 border-b border-dashed border-fuchsia-400/50'>
            ...
            <p>
              www.hemplandusa.com does not and cannot review all communications
              and materials posted to or created by users accessing the site,
              and is not in any manner responsible for the content of these
              ...
              on the site, www.hemplandusa.com is merely acting as a passive
              conduit for such distribution and is not undertaking any
              obligation or liability relating to any contents or activities on
              the site. However, www.hemplandusa.com reserves the right to block
              or remove communications or materials that it determines to be (a)
              ...
              otherwise unacceptable to www.hemplandusa.com in its sole
              discretion.
            </p>
          </div>
          <div className='pb-14 mb-5 border-b border-dashed border-fuchsia-400/50'>
          ...
          <div className='pb-14 mb-5 border-b border-dashed border-fuchsia-400/50'>
            ...
            <p>
              ...
              www.hemplandusa.com may link to sites operated by third parties.
              However, even if the third party is affiliated with
              www.hemplandusa.com, www.hemplandusa.com has no control over these
              linked sites, all of which have separate privacy and data
              collection practices, independent of www.hemplandusa.com. These
              linked sites are only for your convenience and therefore you
              access them at your own risk. Nonetheless, www.hemplandusa.com
              seeks to protect the integrity of its web site and the links
              placed upon it and therefore requests any feedback on not only its
              own site, but for sites it links to as well (including if a
